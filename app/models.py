...
from app.server import db, AppServer
...
db.event.listen(db.session, 'before_commit', SearchableIndex.before_commit)
db.event.listen(db.session, 'after_commit', SearchableIndex.after_commit)
